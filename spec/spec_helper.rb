...
require_relative './support/contain_partial_hash'
...
require File.join(File.dirname(__FILE__), '..', 'controllers', 'games')
require File.join(File.dirname(__FILE__), '..', 'controllers', 'actions')
...
RSpec.configure do |config|
  ...
  config.include LB::Test::DbTools
